...
export async function CheckAndSendNoPaymentMethodAddedNotifications() {
  ...
  let users = await db.User.findAll({
    ...
    group: [
      ...
      "User.userType",
      "User.userRole",
      "User.averageTransactionPerYear",
      "User.inviteCodeUsed",
      "User.myInviteCode",
      "User.inviteCodeRedeemed",
      "User.plan_status",
      "User.stripeCustomerIdLive",
      "User.stripeCustomerIdTest",
      "User.totalSecondsAvailable",
      "User.cancelPlanRedemptions",
      "User.projectSizeKw",
      "User.areaOfService",
      "User.company",
      "User.projectsPerYear",
      "User.primaryClientType",
      "User.website",
      "User.timeZone",
      "User.fcm_token",
      "User.city",
      ...
      "User.nextChargeDate",
      "User.lastPaymentMethodAddedAt",
      "User.collectionStrategies",
      "User.createdAt",
      "User.updatedAt",
    ],
