...
declare class SDK {
     ...
     */
    voiceCall(body: types.VoiceCallBodyParam): Promise<FetchResponse<200, types.VoiceCallResponse200>>;
    /**
     ...
     */
    getPhoneCall(metadata?: types.GetPhoneCallMetadataParam): Promise<FetchResponse<200, types.GetPhoneCallResponse200>>;
    /**
     ...
     */
    createAgent(body: types.CreateAgentBodyParam): Promise<FetchResponse<200, types.CreateAgentResponse200>>;
    /**
     ...
     */
    getAgents(body: types.GetAgentsBodyParam): Promise<FetchResponse<200, types.GetAgentsResponse200>>;
    /**
     ...
     */
    getNumbers(body: types.GetNumbersBodyParam): Promise<FetchResponse<200, types.GetNumbersResponse200>>;
    /**
     * Delete Assistant
     *
     * @throws FetchError<400, types.GetNumbersCopyResponse400> 400
     */
    getNumbersCopy(body: types.GetNumbersCopyBodyParam): Promise<FetchResponse<200, types.GetNumbersCopyResponse200>>;
    /**
     ...
     */
    getNumbersCopy1(body: types.GetNumbersCopy1BodyParam): Promise<FetchResponse<200, types.GetNumbersCopy1Response200>>;
    /**
     * Initiates a real-time voice call through the AI assistant.
     *
     ...
     */
    makePhoneCallCopy(body: types.MakePhoneCallCopyBodyParam): Promise<FetchResponse<200, types.MakePhoneCallCopyResponse200>>;
}
