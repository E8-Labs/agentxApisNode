export function generateNewAccountEmail(data) {
  console.log("Data Email", data);
  const { Sender_Name, Subject } = data;
  ...
  const HtmlTemplate = `
        ...
        <body>
          <div class="container">
            <div class="header">New Account Notification</div>
            <div class="body">
              <p>Hi Admin,</p>
              <p>There was a new account created by <strong>${Sender_Name}</strong>:</p>
