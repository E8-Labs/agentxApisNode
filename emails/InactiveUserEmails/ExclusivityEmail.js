export function generateExclusivityEmail(Name, Same_City, CTA_Link, CTA_Text) {
...
.cta:hover .ctaText {
  color: #ffffff !important; /* Keeps text white on hover */
        ...
        <body>
          <div class="container">
            <div class="header">You’re leading the way in your area!</div>
            <div class="body">
              <p>Hi {Name},</p>
              <p>Right now, you’re part of a select group of agents in [Same City] leveraging AI to secure more listings. Others are catching on, but you’ve got the advantage.</p>
              <p>Let’s turn your lead into more wins—activate your AI today and dominate your market!</p>
  ...
  return {
    ...
    subject: "You’re leading the way in your area!",
  };
}
