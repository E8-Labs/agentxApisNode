...
<body>
  <div class="container">
    ...
    <div class="body">
      <p>Hi {Name},</p>
      <p>You’ve successfully signed up for AgentX—great move! Your AI is ready to go, but there’s just one small step left.</p>
      <p>✅ You’ll need to complete your account to start using your AI!</p>
...
export function GenerateNoPaymentEmail(Name, CTA_Link, CTA_Text) {
  ...
  return {
    html: emailTemplate,
    subject: "You’re In! But One Step Left to Activate Your AI!",
  };
}
